...
**Tổng kết:** 7 lỗi gặp phải, tất cả đã xử lý. Đánh giá trung thực (xem bảng phân loại cuối file): 2 lỗi do môi trường/cơ chế công cụ, 1 nửa-nửa, **4 lỗi do mình dùng công cụ chưa đúng hoặc setup ẩu** — không có lỗi nào là "OSS hỏng". Không có lỗi logic nghiệp vụ (tính tồn kho / hao hụt đều đúng).
